// This program calculates the aggregate of two students and decides which student should be assigned the roll no. first
...
// Decision making using if statement
	...
	{
		cout <<"First roll number will be assigned to: "<<nameStd1;
	}
	
	if(ecatMarksStd1 < ecatMarksStd2)
	{
		cout <<"First roll number will be assigned to: "<<nameStd2;
	}
}